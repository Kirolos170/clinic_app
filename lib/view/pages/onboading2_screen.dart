import 'package:clinic/view/pages/signin_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

import '../../constants.dart';
class Onboading2Screen extends StatelessWidget {
      ...
      body: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              Image.asset("images/select doc 1.png",width: ScreenUtil().setWidth(341),height: ScreenUtil().setHeight(341),) ,
              Expanded(
                child: Container(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("Communicate with your doctor" ,style: TextStyle(
                      ...
                      Padding(
                        ...
                        child: Text("Once you access the profile of doctor you selected you can communicate with him and send any message" ,style: TextStyle(
